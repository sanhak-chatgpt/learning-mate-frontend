...
export type LectureDtoResponseStatusEnum =
  (typeof LectureDtoResponseStatusEnum)[keyof typeof LectureDtoResponseStatusEnum];
...
export function LectureDtoResponseFromJSONTyped(
  json: any,
