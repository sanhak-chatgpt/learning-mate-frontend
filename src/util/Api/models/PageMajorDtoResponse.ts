...
export function PageMajorDtoResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    content: !exists(json, 'content')
      ? undefined
      : (json['content'] as Array<any>).map(MajorDtoResponseFromJSON),
  ...
  return {
    ...
    content:
      value.content === undefined
        ? undefined
        : (value.content as Array<any>).map(MajorDtoResponseToJSON),
    number: value.number,
