...
export function GeneratePresignedUrlDtoResponseFromJSON(
  json: any
): GeneratePresignedUrlDtoResponse {
  return GeneratePresignedUrlDtoResponseFromJSONTyped(json, false);
}

export function GeneratePresignedUrlDtoResponseFromJSONTyped(
  json: any,
...
export function GeneratePresignedUrlDtoResponseToJSON(
  value?: GeneratePresignedUrlDtoResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
