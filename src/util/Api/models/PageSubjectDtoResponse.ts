...
export function PageSubjectDtoResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageSubjectDtoResponse {
    ...
    return {
        ...
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(SubjectDtoResponseFromJSON)),
...
export function PageSubjectDtoResponseToJSON(value?: PageSubjectDtoResponse | null): any {
    ...
    return {
        ...
        'size': value.size,
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(SubjectDtoResponseToJSON)),
        'number': value.number,
